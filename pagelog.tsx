...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res || (res as any).error) {
        throw new Error((res as any)?.error || "Invalid credentials")
      }
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      ...
      <p className="mt-4 text-sm">Don't have an account? <a href="/register/student" className="text-primary hover:underline">Register as student</a> or <a href="/register/company" className="text-primary hover:underline">company</a>.</p>
    </div>
  )
}
